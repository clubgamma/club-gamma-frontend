    ...
    return (
        <>
            ...
            <nav
                ...
                <div className="hidden lg:flex font-dm-sans items-center">
                    {Global.user ? (
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="ghost" className="relative outline-none h-12 pl-2 pr-4 hover:bg-transparent group">
                            ...
                            <DropdownMenuContent className="w-44 font-dm-sans bg-[rgba(36,21,21,0.95)] text-white border-none rounded-md shadow-lg" align="end" forceMount>
