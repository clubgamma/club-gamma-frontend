          ...
          <div className="bg-[#2A2A2A] rounded-xl shadow-lg border border-[#3A3A3A]">
            ...
            <div className="p-4 border-t border-none">
              <div className="flex flex-col items-center justify-between space-y-4 md:flex-row md:space-y-0">
                ...
                >
                  <SelectTrigger className="w-full md:w-[180px] bg-[#3A3A3A] border-none text-white">
                    <SelectValue placeholder="Select rows per page" />
                  </SelectTrigger>
                  <SelectContent className="bg-[#3A3A3A] border-none  text-white">
