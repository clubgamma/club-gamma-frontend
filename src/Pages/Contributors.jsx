  ...
  return (
    <>
      <SEO
        ...
        keywords={`Club Gamma,${repoName || "Club Gamma"
          } contributors,open source,github ${repoName || "Club Gamma"
          },project collaborators,developer community`}
      />
      <div className="min-h-screen p-4 mb-20 sm:mb-0 sm:p-32 bg-gradient-to-br from-[#1e1e1e] to-[#4e3535] flex flex-col items-center pt-32">
        {/* Header Card */}
